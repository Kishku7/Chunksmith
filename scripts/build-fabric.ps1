...
$m26 = [ordered]@{
  "26.1" = @{ mc = "26.1.2";          api = "0.155.3+26.1.2"; dep = ">=26.1- <26.2"; packFormat = "84" }
  "26.2" = @{ mc = "26.2";            api = "0.160.0+26.2";   dep = ">=26.2- <26.3"; packFormat = "88" }
  "26.3" = @{ mc = "26.3";            api = "0.160.7+26.3";   dep = ">=26.3- <26.4"; packFormat = "97" }
}
