...
public interface MinecraftServerExtension {
     ...
     * collect on it. So ticket work runs here instead, once per tick from the {@code tickServer}
     * housekeeping hook, outside every chunk-system iteration.
     *
     ...
     * paused: {@code tickChunks}, whose walk the safe point protects, does not run. Propagation is
