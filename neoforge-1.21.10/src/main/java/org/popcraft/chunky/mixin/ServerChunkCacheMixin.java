 ...
 * through {@code thenApplyAsync(Function.identity(), ...)} and discarded in {@code NeoForgeWorld},
 * so only the declared type changes - no consumer logic does. {@code ChunkStatus} also moved to
 * {@code net.minecraft.world.level.chunk.status} in the 1.20.5 worldgen refactor.
 */
