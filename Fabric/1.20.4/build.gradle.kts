// ChunkSmith Fabric cell - MC 1.20.4 (single-cross-version-source model, Goal 5).
...
//
// Tooling: fabric-loom 1.12.7 + Gradle 8.14 + JDK 17 (MC 1.20.4 runs on Java 17 -- era-correct,
// matching the old 1.20.4 cell). This is the ONE cell that compiles shared_common at --release 17,
