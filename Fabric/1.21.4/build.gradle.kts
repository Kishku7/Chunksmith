// ChunkSmith Fabric cell - MC 1.21.4 (single-cross-version-source model, Goal 5).
...
//
// Tooling: fabric-loom 1.12.7 + Gradle 8.14 + JDK 21 (the proven 1.21.4 set - this cell built
