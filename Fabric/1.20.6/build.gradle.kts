// ChunkSmith Fabric cell - MC 1.20.6 (single-cross-version-source model, Goal 5).
...
// runtime.
//
// Tooling: fabric-loom 1.12.7 + Gradle 8.14 + JDK 21 (MC 1.20.5+ requires Java 21; loom/gradle
// upgraded from the old 1.20.6 cell's loom 1.10.5 / gradle 8.13 to the proven 1.21.x set, a
// best-case-tooling bump). -Xlint:all + zero warnings.
