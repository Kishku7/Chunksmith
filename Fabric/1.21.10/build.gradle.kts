// ChunkSmith Fabric cell - MC 1.21.10 (single-cross-version-source model, Goal 5).
// MODERN reference cell. Compiles the Cog-generated output (gen/) plus the
...
//
// Tooling: fabric-loom 1.12.7 + Gradle 8.14 + JDK 21 (the proven 1.21.10 set - this cell built
