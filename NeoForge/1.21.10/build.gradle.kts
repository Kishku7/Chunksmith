// ChunkSmith NeoForge cell - MC 1.21.10 (single-cross-version-source model, Goal 5).
// modern_pre11 era. Compiles the Cog-generated output (gen/) plus the per-cell
    ...
    processResources {
        ...
        filesMatching("META-INF/neoforge.mods.toml") {
            expand(
                ...
                "neoforgeRange" to (System.getenv("NEOFORGE_RANGE") ?: "[21.9,21.11)"),
                "mcRange" to (System.getenv("MC_RANGE") ?: "[1.21.9,1.21.11)")
            )
        }
    }
    shadowJar {
