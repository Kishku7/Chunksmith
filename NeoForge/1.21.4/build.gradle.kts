// ChunkSmith NeoForge cell - MC 1.21.4 (single-cross-version-source model, Goal 5).
    ...
    processResources {
        ...
        filesMatching("META-INF/neoforge.mods.toml") {
            expand(
                ...
                "neoforgeRange" to (System.getenv("NEOFORGE_RANGE") ?: "[21.2,21.5)"),
                "mcRange" to (System.getenv("MC_RANGE") ?: "[1.21.2,1.21.5)")
            )
        }
    }
    shadowJar {
