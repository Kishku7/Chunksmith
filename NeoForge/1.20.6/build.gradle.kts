...
//
// NeoForge namespace exists from 1.20.2; 1.20.6 is a valid NeoForge target (1.20.5+ requires JDK 21).
// Tooling: ModDevGradle 2.0.141 + Gradle 8.14 + JDK 21. Mojmap-native, NO mixin annotation processor
// + NO refmap. -Xlint:all + zero warnings.
    ...
    processResources {
        ...
        filesMatching("META-INF/neoforge.mods.toml") {
            expand(
                ...
                "neoforgeRange" to (System.getenv("NEOFORGE_RANGE") ?: "[20.5,20.7)"),
                "mcRange" to (System.getenv("MC_RANGE") ?: "[1.20.5,1.21)")
            )
        }
    }
    shadowJar {
