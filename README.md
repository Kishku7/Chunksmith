...
- **Mod — Fabric** — download `Chunksmith-Mod-Fabric-<version>.jar` and drop it in `mods/` (requires Fabric API).
- **Mod — NeoForge** — download `Chunksmith-Mod-NeoForge-<version>.jar` and drop it in `mods/`.
