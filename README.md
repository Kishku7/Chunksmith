...
This branch holds the Chunksmith **mod** build for Minecraft 1.20.1–1.20.6, organised loader-on-top.
...
Shared logic lives in [`common/`](https://github.com/Kishku7/Chunksmith/tree/1.20.x/common) (MC-agnostic core) and [`nbt/`](https://github.com/Kishku7/Chunksmith/tree/1.20.x/nbt) (region NBT handling); each loader/version folder is a standalone build root that shades them in.
